...
@Component({
  selector: 'app-intake-search-modal',
  templateUrl: './intake-search-modal.component.html',
  styleUrls: ['./intake-search-modal.component.scss'],
})
export class IntakeSearchModalComponent implements OnInit {
