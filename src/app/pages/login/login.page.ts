...
export class LoginPage implements OnInit {
  ...
  // setOperatingHoursSlidesPerView() {
  //   const screenWidth = this.plt.width();
  //   if (screenWidth <= 756) {
  //     this.operationHoursSlider.slidesPerView = 1;
  //   } else if (screenWidth <= 992) {
  //     this.operationHoursSlider.slidesPerView = 2;
  //   } else {
  //     this.operationHoursSlider.slidesPerView = 3;
  //   }
  //   this.changeDetRef.detectChanges();
  //   console.log(this.operationHoursSlider);
  // }
